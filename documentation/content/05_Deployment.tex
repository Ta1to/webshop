...
\begin{lstlisting}[language={}, caption=Secrets-Injektion als Umgebungsvariablen im Workflow, label=lst:secrets]
env:
  VITE_FIREBASE_API_KEY:            ${{ secrets.VITE_FIREBASE_API_KEY }}
...
\begin{lstlisting}[language=Java, morekeywords={import, export, const, from, default, defineConfig}, caption=Vite-Konfiguration mit manuellem Chunk-Splitting (vite.config.js), label=lst:vite-config]
