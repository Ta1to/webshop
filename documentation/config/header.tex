...
\usepackage{microtype}              % Besserer Randausgleich, reduziert Overfull-Warnungen
...
%% Quelltext
\usepackage{listings}
\usepackage{upquote}                        % Gerade Anführungszeichen in Listings

% Syntax-Farben
\definecolor{comment}{HTML}{3D7A3D}         % Kommentare – gedämpftes Grün
\definecolor{keyword}{HTML}{1A4CB5}         % Schlüsselwörter – kräftiges Blau
\definecolor{background}{HTML}{F5F5F5}      % Hintergrund – sehr helles Grau
\definecolor{string}{HTML}{B85C00}          % Zeichenketten – warmes Orange
\definecolor{lst@frame}{HTML}{CECECE}       % Rahmenfarbe
\definecolor{lst@lineno}{HTML}{ABABAB}      % Zeilennummernfarbe
...
\lstset{%
    ...
    breaklines        = true,
    postbreak         = \mbox{\textcolor{lst@lineno}{$\hookrightarrow$}\space},
    % Beschriftung
    captionpos        = t,
    % Syntaxhervorhebung
    ...
    numbers           = left,
    numbersep         = 1.2em,
    numberstyle       = \scriptsize\color{lst@lineno}\ttfamily,
    stepnumber        = 1,
    % Rahmen
    frame             = single,
...
\lstdefinelanguage{JavaScript}{%
  keywords={break, case, catch, class, const, continue, debugger, default,
            ...
            while, with, yield, async, await, defineConfig, resolve},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
